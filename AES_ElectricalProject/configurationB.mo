...
model configurationB
  ...
  Modelica.Blocks.Sources.RealExpression Pe_confB(y = if time <= 1800 then 170e6 elseif time <= 3600 then 180e6
  ...
  Modelica.Blocks.Continuous.TransferFunction tf_g1(a = {10, 0}, b = {1}) annotation(
...
equation
  ...
  connect(feedback_g1.u1, fo.y) annotation(
    Line(points = {{-218, -10}, {-250, -10}, {-250, 50}, {-259, 50}}, color = {0, 0, 127}));
  ...
  connect(gain2.y, prim_sec_terz_2.u1) annotation(
    Line(points = {{-100, 21}, {-100, -42}, {-82, -42}}, color = {0, 0, 127}));
